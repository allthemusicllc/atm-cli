...
sourcesIndex["filetime"] = {"name":"","dirs":[{"name":"unix","dirs":[],"files":["mod.rs","utimes.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["xattr"] = {"name":"","dirs":[{"name":"sys","dirs":[{"name":"linux_macos","dirs":[],"files":["macos.rs","mod.rs"]}],"files":["mod.rs"]}],"files":["error.rs","lib.rs","util.rs"]};
createSourceSidebar();
